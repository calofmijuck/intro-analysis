...
\end{enumerate}~\\
\textbf{Cor 3.3.3} Suppose $f:X\ra Y$ is uniformly continuous. Then there exists a unique continuous extension of $f$ to $\overline{A}$.\footnote{$Y$ is assumed to be extended to $\R^d$.}\\
