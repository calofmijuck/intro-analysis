...
\thm{11.28} \note{Lebesgue's Monotone Convergence Theorem} Let \(f_n: X \ra [0, \infty]\) be measurable functions\footnote{Non-negative인 것이 중요합니다!} and \(f_n(x) \leq f_{n+1}(x)\) for all \(x \in X\). Let \[
